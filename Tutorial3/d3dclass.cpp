...
bool D3DClass::Initialize(int screenWidth, int screenHeight, bool vsync, HWND hwnd, bool fullscreen, float screenDepth, float screenNear)
{
	...
	// Enumarate the primary adapter output (monitor)
	...
	// Set the feature level to DirectX
	featureLevel = D3D_FEATURE_LEVEL_11_0;

	// Create the swap chain, Direct3D device, Direct3D device context
	...
	// Create the rasterizer state from the description filled
...
{
	// Before shutting down, set to windowed mode or it will throw exception on swap chain release
	if (m_swapChain)
	{
